...
xml.write("     <logger logEvery=\""+str(args.numIter/5000)+"\" fileName=\""+args.output+".trees\" mode=\"tree\">\n       <log idref=\'treePrior\'/>\n     </logger>\n")

xml.write("     <logger logEvery=\""+str(args.numIter/1000)+"\">\n       <model idref=\'posterior\'/>\n       <log idref=\"posterior\"/>\n       <log idref=\"treeLikelihood\"/>\n       <log spec=\'TreeHeightLogger\' tree=\'@tree\'/>\n       <log idref=\"migModel\"/>\n       <log idref=\"mutationRate\"/>\n       <ESS spec=\'ESS\' name=\'log\' arg=\"@treePrior\"/>\n       <ESS spec=\'ESS\' name=\'log\' arg=\"@posterior\"/>\n     </logger>\n\n   </run>\n </beast>\n\n")
