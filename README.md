...
### core_snp_consensus
This folder contain various combination of core/non-core consensus fasta files for individual samples and annotaed vcf results. 

### gubbins: 
This folder contains various combination of core/non-core multi-fasta consensus generated by merging individual consensus files in core_snp_consensus folder. 

**var_consensus.fa:** consensus generated from core variant positions.

**ref_var_consensus.fa** full consensus relative to the reference genome generated from core variant positions (final core variant positions + reference allele positions + non-core variant positions). 
