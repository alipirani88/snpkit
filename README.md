...
- [Running pipeline on Compute cluster(Supported system: pbs)](https://github.com/alipirani88/variant_calling_pipeline/blob/master/README.md#Running pipeline on Compute cluster(Supported system: pbs))
### Installation
